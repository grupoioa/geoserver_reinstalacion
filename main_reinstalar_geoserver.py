...
URL_GEOSERVER  = 'http://localhost:8080/geoserver'
#Direcciones de de nuestra informacion del GEOSERVER a respaldar
PATH_WORKSPACE = '/$PATH_RESPALDOS/workspaces/'
PATH_LAYERS    = '/$PATH_RESPALDOS/layers/'
PATH_STYLES    = '/$PATH_RESPALDOS/workspaces/$WORKSPACE/styles/'
